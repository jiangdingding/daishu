...
<body>
	...
	<div class="warp-bg">
		<div class="logo warp">
			<a href="/index.php" target="_blank"><img
				src="/themes/ruizhict/style/css/img/logo.png" alt="贷鼠网" /> </a>
			<p>
	...
	<div class="box-bg">
		...
		<table width="400" height="160px" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td width="120" height="35" align="center">用户名：</td>
          ...
          <tr>
            <td width="120" height="35" align="center">密&nbsp;&nbsp;码：</td>
            <td width="190"><input name="password" type="password" size="21" maxlength="20"  tabindex="2" style="width:145px;"/></td>
            </tr>
          <tr>
            <td width="120" height="35" align="center">验证码：</td>
            <td width="190"><input name="valicode" type="text" size="11" maxlength="4"  tabindex="3"/><img src="plugins/index.php?q=imgcode" alt="点击刷新" onClick="this.src='plugins/index.php?q=imgcode&t=' + Math.random();" align="absmiddle" style="cursor:pointer;float:right" /></td>
          </tr>
        </table>
