...
?>
		...
		<div class="floatr">
			用户名：<input type="text" name="username" id="username" value="<? if (!isset($_REQUEST['username'])) $_REQUEST['username'] = ''; echo $_REQUEST['username']; ?>"/> 状态<select id="status" ><option value="">全部</option><option value="1" <? if (!isset($_REQUEST['real_status'])) $_REQUEST['real_status']=''; ;if (  $_REQUEST['real_status']==1): ?> selected="selected"<? endif; ?>>已通过</option><option value="0" <? if (!isset($_REQUEST['real_status'])) $_REQUEST['real_status']=''; ;if (  $_REQUEST['real_status']=="0"): ?> selected="selected"<? endif; ?>>未通过</option></select> <input type="button" value="搜索" / onclick="sousuo()">
		</div>
		</td>
	</tr>
		<tr>
	...
	<tr>
	  ...
	  var url = '<? if (!isset($this->magic_vars['_A']['query_url'])) $this->magic_vars['_A']['query_url'] = ''; echo $this->magic_vars['_A']['query_url']; ?>/vip&type=<? if (!isset($_REQUEST['type'])) $_REQUEST['type'] = ''; echo $_REQUEST['type']; ?>';
	  	...
	  	function sousuo(){
			...
			<div class="floatr">
				用户名：<input type="text" name="keywords" id="keywords" value="<? if (!isset($_REQUEST['keywords'])) $_REQUEST['keywords'] = ''; echo $_REQUEST['keywords']; ?>"/> 	客服用户名：<input type="text" name="kefu" id="kefu" value="<? if (!isset($_REQUEST['kefu'])) $_REQUEST['kefu'] = ''; echo $_REQUEST['kefu']; ?>"/> <input type="button" value="搜索" / onclick="sousuo()">
			</div>
			</td>
		</tr>
	<tr>
...
?>
		<tr  <? if (!isset($this->magic_vars['key'])) $this->magic_vars['key']=''; ;if (  $this->magic_vars['key']%2==1): ?> class="tr2"<? endif; ?>>
			...
			<td class="main_td1" align="center" ><? if (!isset($this->magic_vars['item']['phone_status'])) $this->magic_vars['item']['phone_status']=''; ;if (  $this->magic_vars['item']['phone_status']>1): ?><font color="#999999">[手机：<? if (!isset($this->magic_vars['item']['phone_status'])) $this->magic_vars['item']['phone_status'] = ''; echo $this->magic_vars['item']['phone_status']; ?>]</font> <a href="javascript:void(0)" onclick='tipsWindown("手机认证审核","url:get?<? if (!isset($this->magic_vars['_A']['query_url'])) $this->magic_vars['_A']['query_url'] = ''; echo $this->magic_vars['_A']['query_url']; ?>/audit&user_id=<? if (!isset($this->magic_vars['item']['user_id'])) $this->magic_vars['item']['user_id'] = ''; echo $this->magic_vars['item']['user_id']; ?>&type=phone",500,230,"true","","true","text");'><font color="#FF0000">等待审核</font></a><? if (!isset($this->magic_vars['item']['phone_status'])) $this->magic_vars['item']['phone_status']=''; ;elseif (  $this->magic_vars['item']['phone_status']==1): ?><font color="#999999">[手机：<? if (!isset($this->magic_vars['item']['phone'])) $this->magic_vars['item']['phone'] = ''; echo $this->magic_vars['item']['phone']; ?>]</font><font color="#009900">审核通过</font><? else: ?><font color="#cccccc">没有申请</font><? endif; ?></td>
		...
		<div class="floatr">
			用户名：<input type="text" name="username" id="username" value="<? if (!isset($_REQUEST['username'])) $_REQUEST['username'] = ''; echo $_REQUEST['username']; ?>"/> 真实姓名：<input type="text" name="realname" id="realname" value="<? if (!isset($_REQUEST['realname'])) $_REQUEST['realname'] = ''; echo $_REQUEST['realname']; ?>"/> 状态<select id="type" ><option value="">全部</option>
	...
	<tr>
	  ...
	  var url = '<? if (!isset($this->magic_vars['_A']['query_url'])) $this->magic_vars['_A']['query_url'] = ''; echo $this->magic_vars['_A']['query_url']; ?>/viewall';
	  	...
	  	function sousuo(){
			...
			<div class="floatr">
				用户名：<input type="text" name="keywords" id="keywords" value="<? if (!isset($_REQUEST['keywords'])) $_REQUEST['keywords'] = ''; echo $_REQUEST['keywords']; ?>"/> 姓名：<input type="text" name="realname" id="realname" value="<? if (!isset($_REQUEST['realname'])) $_REQUEST['realname'] = ''; echo $_REQUEST['realname']; ?>"/> <input type="button" value="搜索" / onclick="sousuo()">
			</div>
			</td>
		</tr>
	<tr>
