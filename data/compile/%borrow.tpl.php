...
?>
		<tr  <? if (!isset($this->magic_vars['key'])) $this->magic_vars['key']=''; ;if (  $this->magic_vars['key']%2==1): ?> class="tr2"<? endif; ?>>
			...
			<td><select name="flag[]"><option value="0" <? if (!isset($this->magic_vars['item']['flag'])) $this->magic_vars['item']['flag']=''; ;if (  $this->magic_vars['item']['flag']==0): ?> selected="selected"<? endif; ?>>普通标</option><option  value="1" <? if (!isset($this->magic_vars['item']['flag'])) $this->magic_vars['item']['flag']=''; ;if (  $this->magic_vars['item']['flag']==1): ?> selected="selected"<? endif; ?>>推荐标</option><option value="2" <? if (!isset($this->magic_vars['item']['flag'])) $this->magic_vars['item']['flag']=''; ;if (  $this->magic_vars['item']['flag']==2): ?> selected="selected"<? endif; ?>>担保标</option><option  value="3" <? if (!isset($this->magic_vars['item']['flag'])) $this->magic_vars['item']['flag']=''; ;if (  $this->magic_vars['item']['flag']==3): ?> selected="selected"<? endif; ?>>抵押标</option></select></td>
...
?>
		<tr  <? if (!isset($this->magic_vars['key'])) $this->magic_vars['key']=''; ;if (  $this->magic_vars['key']%2==1): ?> class="tr2"<? endif; ?>>
			...
			<td><? if (!isset($this->magic_vars['item']['status'])) $this->magic_vars['item']['status']=''; ;if (  $this->magic_vars['item']['status']==1): ?><font color="#006600">已还</font><? else: ?><font color="#FF0000">未还</font><? endif; ?></td>
		</tr>
		<? endforeach; endif; unset($_from); ?>
		<tr>
		<td colspan="10" class="action">
		...
		<div class="floatr">
			用户名：<input type="text" name="username" id="username" value="<? if (!isset($_REQUEST['username'])) $_REQUEST['username'] = ''; echo $_REQUEST['username']; ?>"/>关键字：
			<input type="text" name="keywords" id="keywords" value="<? if (!isset($_REQUEST['keywords'])) $_REQUEST['keywords'] = ''; echo $_REQUEST['keywords']; ?>"/><select id="status" >
...
var urls = '<? if (!isset($this->magic_vars['_A']['query_url'])) $this->magic_vars['_A']['query_url'] = ''; echo $this->magic_vars['_A']['query_url']; ?>';
