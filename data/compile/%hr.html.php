  <? $this->magic_include(array('file' => "header.html", 'vars' => array()));?>
	...
	<div class="main-part box-shadow-white" id="page_wraper">
		...
		<div class="article_content">
			<? $this->magic_vars['query_type']='GetList';$data = array('var'=>'loop','epage'=>'20','keywords'=>isset($_REQUEST['keywords'])?$_REQUEST['keywords']:'','site_id'=>$this->magic_vars['_G']['site_result']['site_id']);$data['page'] = isset($_REQUEST['page'])?$_REQUEST['page']:'';  include_once(ROOT_PATH.'modules/invite/invite.class.php');$this->magic_vars['magic_result'] = inviteClass::GetList($data); $this->magic_vars['loop']['list'] =  $this->magic_vars['magic_result']['list']; $this->magic_vars['loop']['page'] =  $this->magic_vars['magic_result']['page']; $this->magic_vars['loop']['epage'] =  $this->magic_vars['magic_result']['epage']; $this->magic_vars['loop']['total'] =  $this->magic_vars['magic_result']['total']; $this->magic_vars['loop']['showpage'] =  show_pages($this->magic_vars['magic_result']);?>
