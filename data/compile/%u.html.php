...
<div class="con_box t10">
     <div class="user_choic">
	      <div class="user_choic1">
		       <ul>
			      	<li <? if (!isset($this->magic_vars['U_gid'])) $this->magic_vars['U_gid']=''; ;if (  $this->magic_vars['U_gid'] == ''): ?>class="a1"<? endif; ?>><a href="/u/<? if (!isset($this->magic_vars['GU_uid'])) $this->magic_vars['GU_uid'] = ''; echo $this->magic_vars['GU_uid']; ?>">个人信息</a></li>
					<li <? if (!isset($this->magic_vars['U_gid'])) $this->magic_vars['U_gid']=''; ;if (  $this->magic_vars['U_gid'] == 'borrowlist'): ?>class="a1"<? endif; ?>><a href="/u/<? if (!isset($this->magic_vars['GU_uid'])) $this->magic_vars['GU_uid'] = ''; echo $this->magic_vars['GU_uid']; ?>/borrowlist" >借款列表</a></li>
					<li <? if (!isset($this->magic_vars['U_gid'])) $this->magic_vars['U_gid']=''; ;if (  $this->magic_vars['U_gid'] == 'borrowinvest'): ?>class="a1"<? endif; ?>><a href="/u/<? if (!isset($this->magic_vars['GU_uid'])) $this->magic_vars['GU_uid'] = ''; echo $this->magic_vars['GU_uid']; ?>/borrowinvest">投资记录</a></li>
					<li ><A 
...
<div class="user_left" style="background-color: #FFF;">
<div class="index-middle-r i-news-w block-r" style="width:200px;">
	<div class="block-title clearfix" style="background: #375eb7;color:#FFF;">
		<span class="fl">个人信息</span> <span class="fr"><a href="">+</a>
		</span>
	</div>
	
                  <div class="Borrower_people_leftbox" style="padding-top:10px;padding-bottom:10px">
    <dl style="height: auto;">
        <dd style="text-align:center">
            <a href="http://www.sosodai.com/u/1334" target="_blank"><img src="../../data/images/avatar/noavatar_middle.gif" width="100" height="100" class="ShowPicZoom"  style="height:119px;width:111px;border-width:0px;" title="6688"  /></a></dd>
        <dt>
            <ul style="padding-left:5px;">
                <li style="margin-bottom: 0px;"><span style="float: left; width: 60px; text-align: right; ">会员等级：</span>
					<img src="<? if (!isset($this->magic_vars['_G']['system']['con_credit_picurl'])) $this->magic_vars['_G']['system']['con_credit_picurl'] = ''; echo $this->magic_vars['_G']['system']['con_credit_picurl']; ?><? if (!isset($this->magic_vars['var']['user']['credit_pic'])) $this->magic_vars['var']['user']['credit_pic'] = ''; echo $this->magic_vars['var']['user']['credit_pic']; ?>" title="<? if (!isset($this->magic_vars['var']['user']['credit_jifen'])) $this->magic_vars['var']['user']['credit_jifen'] = ''; echo $this->magic_vars['var']['user']['credit_jifen']; ?>"  />
				</li>
                ...
                <li><span style="float: left; width: 60px; text-align: right;">籍&nbsp;&nbsp;&nbsp;&nbsp;贯：</span>
					<? if (!isset($this->magic_vars['var']['user']['area'])) $this->magic_vars['var']['user']['area'] = '';$_tmp = $this->magic_vars['var']['user']['area'];$_tmp = $this->magic_modifier("area",$_tmp,"p,c");echo $_tmp;unset($_tmp); ?>
                </li>
                <li><span style="float: left; width: 60px;
                    text-align: right;">注册时间：</span>
                    <span><? if (!isset($this->magic_vars['var']['user']['addtime'])) $this->magic_vars['var']['user']['addtime'] = '';$_tmp = $this->magic_vars['var']['user']['addtime'];$_tmp = $this->magic_modifier("date_format",$_tmp,"Y-m-d");echo $_tmp;unset($_tmp); ?></span>
                </li>
				<li><span style="float: left; width: 60px;
                    text-align: right;">最后登录：</span>
                    <span ><? if (!isset($this->magic_vars['var']['user']['lasttime'])) $this->magic_vars['var']['user']['lasttime'] = '';$_tmp = $this->magic_vars['var']['user']['lasttime'];$_tmp = $this->magic_modifier("date_format",$_tmp,"Y-m-d");echo $_tmp;unset($_tmp); ?></span>
                </li>
                 <li><span style="float: left; width: 60px; text-align: right;">信用积分：</span>
                    <span ><? if (!isset($this->magic_vars['var']['user']['credit_jifen'])) $this->magic_vars['var']['user']['credit_jifen'] = ''; echo $this->magic_vars['var']['user']['credit_jifen']; ?></span>分 </li>
                <li style="height: 30px;">
                <span style="float: left; width: 60px;
                    text-align: right;">认证：</span>
        ...
        <dd style="margin-left: 55px; _margin-left: 30px; height: auto;">
            <ul>
                ...
                <li style="height: 29px; display:none">
                    <a href="#" onclick="javascript:if(confirm('你确定要将此标加入我关注的标？')) location.href='/?user&q=code/borrow/add_care&code=borrow&article_id='"><input type="button" name="button2" id="button2" class="buttomAttention2"  style="cursor:pointer"  /></a>
                </li>
...
<div class="index-middle-r i-news-w block-r" style="width:200px;">
	<div class="block-title clearfix" style="background: #375eb7;color:#FFF;">
		<span class="fl">个人说明</span> <span class="fr"><a href="">+</a>
		</span>
	</div>				
...
<div class="index-middle-r i-news-w block-r" style="width:200px;">
	<div class="block-title clearfix" style="background: #375eb7;color:#FFF;">
		<span class="fl">我的好友</span> <span class="fr"><a href="">+</a>
		</span>
	</div>		

	   <div class="m_l_bor">
			<div class="man_friend1" style="padding:10px;">
			     <ul>
...
?>
					<li style="padding-bottom:5px;"><img src="<? if (!isset($this->magic_vars['var']['friends_userid'])) $this->magic_vars['var']['friends_userid'] = '';$_tmp = $this->magic_vars['var']['friends_userid'];$_tmp = $this->magic_modifier("avatar",$_tmp,"");$_tmp = $this->magic_modifier("litpic",$_tmp,"75,75");echo $_tmp;unset($_tmp); ?>" class="picborder" />&nbsp;&nbsp;&nbsp;<a href="/u/<? if (!isset($this->magic_vars['var']['friends_userid'])) $this->magic_vars['var']['friends_userid'] = ''; echo $this->magic_vars['var']['friends_userid']; ?>"><? if (!isset($this->magic_vars['var']['friend_username'])) $this->magic_vars['var']['friend_username'] = ''; echo $this->magic_vars['var']['friend_username']; ?></a></li>
...
<div class="index-middle-r i-news-w block-r"
				...
				<div class="block-title clearfix"
					...
					<font style="padding-top: 0px;">贷款列表 </font>
				</div>
	   <div class="m_l_bor" style="padding:10px">
...
<div class="index-middle-r i-news-w block-r"
				...
				<div class="block-title clearfix"
					style="background: #375eb7; color: #FFF;">
					<font style="padding-top: 0px;">投标记录 </font>
				</div>
...
<div class="index-middle-r i-news-w block-r"
				...
				<div class="block-title clearfix"
					style="background: #375eb7; color: #FFF;">
					<font style="padding-top: 0px;">好友评价 </font>
				</div>
	   <div class="m_l_bor" style="padding:10px">
