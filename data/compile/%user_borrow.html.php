...
<div class="container clearfix" style="margin-top:15px;">
	...
	<div class="user_right">
		<div class="header-menu" >
			...
			<ul>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="repayment"): ?> class="current"<? endif; ?>><a style="width:125px" href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/repayment">正在还款的借款</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="repaymentplan"): ?> class="current"<? endif; ?>><a style="width:125px" href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/repaymentplan">还款明细账</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="loandetail"): ?> class="current"<? endif; ?>><a style="width:125px" href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/loandetail">借款明细账</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="repaymentyes"): ?> class="current"<? endif; ?>><a style="width:125px" href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/repaymentyes">已还完的借款</a></li>
			...
			<ul>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']='';if (!isset($_REQUEST['type'])) $_REQUEST['type']=''; ;if (  $this->magic_vars['_U']['query_type']=="succes" &&   $_REQUEST['type']==""): ?> class="current"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/succes">已成功投资的借款</a></li>
			...
			<ul>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="myuser"): ?> class="current"<? endif; ?>><a href="index.php?user&q=code/user/myuser">我的客服</a></li>
...
?>
		...
		<input class="button_blue_small" value="搜索" type="submit" />
		</div>
			  <form action="" method="post">
		<table  class="products_table">
				<tr class="head" >
...
<br />
<? if (!isset($this->magic_vars['_G']['system']['con_webname'])) $this->magic_vars['_G']['system']['con_webname'] = ''; echo $this->magic_vars['_G']['system']['con_webname']; ?>提醒您：</font>您还不是VIP会员，请先成为<a href="/vip/index.html"><strong>VIP会员</strong></a>。</div><br /><br /><br />
...
<option value="borrow_vouch" <? if (!isset($_REQUEST['type'])) $_REQUEST['type']=''; ;if (  $_REQUEST['type']=="borrow_vouch"): ?> selected="selected"<? endif; ?>>借款担保额度</option>				
		...
		<? unset($_magic_vars);unset($data); ?>
			  <form action="" method="post">
		<table  class="products_table" style="margin-top:20px">
				<tr class="head" >
					<th  >申请时间</th>
					<th  >申请类型</th>
					<th  >申请金额(元)</th>
...
?>
		...
		* 温馨提示：额度申请后 无论申请是否批准 必须隔一个月后才能再次申请，每个月只能申请一次如有问题,请与我们联系
		...
		<div class="user_help">结果统计：&nbsp;&nbsp;<font color="#234d89">借出总额</font><font color="red">￥<? if (!isset($this->magic_vars['var']['success_account'])) $this->magic_vars['var']['success_account'] = '';$_tmp = $this->magic_vars['var']['success_account'];$_tmp = $this->magic_modifier("default",$_tmp,"0");echo $_tmp;unset($_tmp); ?></font> &nbsp;&nbsp;&nbsp;&nbsp;<font color="#234d89">已收总额</font><font color="red">￥<? if (!isset($this->magic_vars['var']['collection_capital1'])) $this->magic_vars['var']['collection_capital1'] = '';$_tmp = $this->magic_vars['var']['collection_capital1'];$_tmp = $this->magic_modifier("default",$_tmp,"0");echo $_tmp;unset($_tmp); ?> </font>&nbsp;&nbsp;&nbsp;&nbsp;<font color="#234d89">未收总额</font><font color="red">￥<? if (!isset($this->magic_vars['var']['collection_capital0'])) $this->magic_vars['var']['collection_capital0'] = '';$_tmp = $this->magic_vars['var']['collection_capital0'];$_tmp = $this->magic_modifier("default",$_tmp,"0");echo $_tmp;unset($_tmp); ?> </font>&nbsp;&nbsp;&nbsp;&nbsp;<font color="#234d89">已收利息</font><font color="red">￥<? if (!isset($this->magic_vars['var']['collection_interest1'])) $this->magic_vars['var']['collection_interest1'] = '';$_tmp = $this->magic_vars['var']['collection_interest1'];$_tmp = $this->magic_modifier("default",$_tmp,"0");echo $_tmp;unset($_tmp); ?></font> &nbsp;&nbsp;&nbsp;&nbsp;<font color="#234d89">未收利息</font><font color="red">￥<? if (!isset($this->magic_vars['var']['collection_interest0'])) $this->magic_vars['var']['collection_interest0'] = '';$_tmp = $this->magic_vars['var']['collection_interest0'];$_tmp = $this->magic_modifier("default",$_tmp,"0");echo $_tmp;unset($_tmp); ?></font> </div>
		<? unset($_magic_vars);unset($data); ?>
		<hr class="hr-dotted">
		<div style="height:30px; padding-top:7px;padding-bottom:10px;"> 
		发布时间：<input type="text" name="" value="" size="15" /> 到 <input type="text" name="" value="" size="15" />  
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;关键字：<input type="text" name="" value="" size="15" /> 
		<input class="button_blue_small" value="搜索" type="submit" />
		</div>
			  <form action="" method="post">
		<table  class="products_table">
...
?>
		...
		<div style="height:30px; padding-top:7px;padding-bottom:10px;"> 
		发布时间：<input type="text" name="dotime1" id="dotime1" value="<? if (!isset($_REQUEST['dotime1'])) $_REQUEST['dotime1'] = ''; echo $_REQUEST['dotime1']; ?>" size="15" onclick="change_picktime()"/> 到 <input type="text"  name="dotime2" value="<? if (!isset($_REQUEST['dotime2'])) $_REQUEST['dotime2'] = ''; echo $_REQUEST['dotime2']; ?>" id="dotime2" size="15" onclick="change_picktime()"/>  关键字：<input type="text" name="keywords" id="keywords" size="15" value="<? if (!isset($_REQUEST['keywords'])) $_REQUEST['keywords'] = '';$_tmp = $_REQUEST['keywords'];$_tmp = $this->magic_modifier("urldecode",$_tmp,"");echo $_tmp;unset($_tmp); ?>" /> 
		<input  class="button_blue_small" value="搜索" type="submit" onclick="sousuo('<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/tender_vouch')" />
		</div>
			  <form action="" method="post">
		<table  class="products_table">
				<tr class="head" >
...
?>
		...
		<input class="button_blue_small" value="搜索" type="submit" onclick="sousuo('<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/tender_vouch_finish')" />
		</div>
			  <form action="" method="post">
		<table  class="products_table">
				<tr class="head" >
...
?>
    ...
    <? unset($_magic_vars);unset($data); ?>
		...
		<table  class="products_table">
				<tr class="head" >
					<th  width=120px>借款标题</th>
					<th  width=70px>应收日期</th>
					<th  width=70px>借款者</th>
					<th  >第几期/总期数</th>
					<th  >收款总额</th>
					<th  >应收本金</th>
					<th  >应收利息</th>
