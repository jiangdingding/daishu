...
<div class="container clearfix" style="margin-top:15px;">
	...
	<div class="user_right">
		...
		<div class="user_main_title1" style="padding-bottom:10px"><input class="button_blue_small" type="button"  value="删除" onclick="on_submit('<? if (!isset($this->magic_vars['_G']['query_url'])) $this->magic_vars['_G']['query_url'] = ''; echo $this->magic_vars['_G']['query_url']; ?>/sented',1)" /> <input class="button_blue_small" type="button" value="标记已读" onclick="on_submit('<? if (!isset($this->magic_vars['_G']['query_url'])) $this->magic_vars['_G']['query_url'] = ''; echo $this->magic_vars['_G']['query_url']; ?>/sented',2)"/> <input class="button_blue_small" type="button" value="标记未读" onclick="on_submit('<? if (!isset($this->magic_vars['_G']['query_url'])) $this->magic_vars['_G']['query_url'] = ''; echo $this->magic_vars['_G']['query_url']; ?>/sented',3)"/></div>
...
?>
		...
		<div class="user_main_title1" style="padding-bottom:10px"><input type="button"  class="button_blue_small" value="删除" onclick="on_submit('<? if (!isset($this->magic_vars['_G']['query_url'])) $this->magic_vars['_G']['query_url'] = ''; echo $this->magic_vars['_G']['query_url']; ?>/sented',1)" /></div>
		<form action="" method="post" id="form1">
		<div class="user_right_main">
			<table  class="products_table">
				<tr class="head" >
