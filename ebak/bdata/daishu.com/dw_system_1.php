...
E_D("replace into `dw_system` values('3','网站名称','con_webname','贷鼠网','0','1','0');");
E_D("replace into `dw_system` values('4','网站网址','con_weburl','http://daishu.com','0','1','0');");
E_D("replace into `dw_system` values('5','网站路径','con_webpath','','0','1','0');");
E_D("replace into `dw_system` values('6','网站logo','con_logo','','3','1','0');");
E_D("replace into `dw_system` values('7','网站关键词','con_keywords','上海市个人网络信用 无抵押贷款 无抵押 无担保 小额贷款 投资理财 企业融资','0','1','0');");
E_D("replace into `dw_system` values('8','网站描述','con_description','贷鼠网是专业的网上贷款平台，服务于市民的小额贷款需要。愿人人有钱贷，事业人人有成。','0','1','0');");
...
E_D("replace into `dw_system` values('25','水印文字','con_watermark_word','贷鼠网','0','2','1');");
...
E_D("replace into `dw_system` values('42','发件人昵称或姓名','con_email_from_name','贷鼠网投资借贷平台','0','4','0');");
...
E_D("replace into `dw_system` values('46','联系地址','con_address','上海市xx区xx街xx幢xx号','0','1','1');");
...
E_D("replace into `dw_system` values('54','客户中心文字','con_kefutext','欢迎光临贷鼠网投资客服中心！<br />\r\n有任何疑问请联系你的专属客服!','2','1','1');");
...
E_D("replace into `dw_system` values('62','后台地址名称','con_houtai','manage','0','1','1');");
