...
$_A['list_menu'] = "<a href='{$_A['query_url']}{$_A['site_url']}'>用户积分</a> - <a href='{$_A['query_url']}/rank{$_A['site_url']}'>等级管理</a> - <a href='{$_A['query_url']}/type{$_A['site_url']}'>积分类型列表</a> - <a href='{$_A['query_url']}/type_new{$_A['site_url']}'>添加积分类型</a> ";
