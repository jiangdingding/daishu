...
<div class="module_add">
	...
	<div class="module_border">
		...
		<div class="c">
				<input type="text" name="account" value="{$_A.borrow_result.account}" /> <span >借款金额应在500元至50,0000元之间。交易币种均为人民币。借款成功后, 借款2个月 ,收取当前借款金额2%的管理费,借款三个月以上的每月增加0.2%管理费,冻结10%作为保证金,正常还款完后,网站解冻10%的保证金,保证金以最高年利率21.6%返还给用户。更详尽的信息请查看帮助网站 收费规则 </span>
		</div>
	</div>
